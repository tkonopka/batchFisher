...
The second diagram shows operations per second. This calculation rate is constant for the simple approach, but increases for the other methods with the batch size. This is because as more tests are performed, there is more chance of seeing duplicate configurations.
